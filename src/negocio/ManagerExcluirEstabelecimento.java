...
public class ManagerExcluirEstabelecimento {

    public static void preencherBuscaEst(EstabelecimentoBean estabelecimentobean, JTextField jtfNome, 
    		JTextField jtfCnpj, JTextField jtfTelefone, JTextField jtfRamoDeAtividade, JTextField jtfEnderecoNoCampus, 
    		JTextField jtfProprietario, JTextField jtfHorarioDeFuncionamento, JButton btnExcluirCadastro, JButton btnLimpar ){
