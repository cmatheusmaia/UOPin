...
public class TelaExcluirEvento extends JFrame {
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Escolha:",
	...
	comboBox_1.setModel(new DefaultComboBoxModel(new String[] { "Escolha:", "Palestra", "F\u00F3rum",
		"Semin\u00E1rio", "Curso", "Oficina", "Entretenimento" }));
